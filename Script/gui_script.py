...
class win():
    def __init__(self, root=None):
        ...
        self.undo_button        =     Button(self.bottom_frame, text="Undo", pady = 5, padx = 5, font= (14), state="disabled", command = self.undo_button_action)
        self.cancel_button      = Button(self.bottom_frame, text="Cancel", pady = 5, padx = 5, font= (14),state="disabled", command = self.cancel_button_action)
